...
gridWidth:	.word 8
gridHeight:	.word 8
haltLength:	.word 0		# milliseconds
gridSeed:
	# ------------- 8x8 configurations (256 x 256 display) -------------
	...
	# ------------- 16x16 configurations (512 x 512 display) -------------
	# pulsar
	#.byte 0x08, 0x20, 0x08, 0x20, 0x0C, 0x60, 0x00, 0x00, 0xE6, 0xCE, 0x2A, 0xA8, 0x0C, 0x60, 0x00, 0x00, 0x0C, 0x60, 0x2A, 0xA8, 0xE6, 0xCE, 0x00, 0x00, 0x0C, 0x60, 0x08, 0x20, 0x08, 0x20
gridSeedEnd:
